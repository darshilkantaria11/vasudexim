...
export default function CalciumChlorideLumpsSection() {
    const fadeUp = {
    ...
    return (
        <section className="px-6 py-12 md:px-12 lg:px-24 space-y-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    <Image
                        src="/calcium-chloride-lumps.webp" // Replace this later
                        alt="Calcium Chloride Lumps"
                        width={500}
                        height={500}
                ...
                >
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        Our Calcium Chloride Lumps are produced in technical grade, suitable for applications in construction, de-icing, and moisture removal. Known for high purity, our granules ensure excellent performance across industries.
                    </p>
